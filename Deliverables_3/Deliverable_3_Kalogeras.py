...
######################################################################################################################################
##################### SELF NOTE: for this program to run you need to change to the Cplex ENVIROMENT ##################################
######################################################################################################################################
...
rotor_diameter_m = 500          ############## changed Roter diamiter from 220 to 500 ######################
hub_height_m = 130
wt_rated_power_MW = 50          ############## changed rate power from 10 to 50 ######################
surface_tilt_deg = 35
...
b_P = 20
b_E_h  = 3
cost_of_batt_degr = 20    ###################### Changing the cost of battery from 5 tp 20 ###########################
